...
def render_data_status_page():
    ...
    st.write("Streamlit Secrets에 등록된 API 키를 사용하여 5개 데이터 제공자의 연결 상태를 검증합니다.")

    if st.button("API 연결 상태 테스트 실행"):
    ...
    if os.path.exists(report_path):
        ...
        st.info("아직 검증 리포트가 없습니다. 위의 버튼을 눌러 테스트를 진행해 주세요.")
